...
const RestSubSidebar: React.FC = () => {
  ...
  return (
    <nav className={`w-11 border border-border bg-bg flex flex-col py-5 gap-6 items-center shadow-inner h-full theme-${theme}`}>
      <Link to="/collections" className={`flex items-center justify-center group ${location.pathname === '/collections' ? 'text-accent' : 'text-text-secondary'}`}>
      ...
      <Link to="/history" className={`flex items-center justify-center group ${location.pathname === '/history' ? 'text-accent' : 'text-text-secondary'}`}>
      ...
      <Link to="/generate-code" className={`flex items-center justify-center group ${location.pathname === '/generate-code' ? 'text-accent' : 'text-text-secondary'}`}>
