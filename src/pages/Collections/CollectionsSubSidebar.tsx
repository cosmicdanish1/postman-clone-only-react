  ...
  return (
    <nav className="w-14 bg-zinc-900 flex flex-col py-5 gap-8 items-center shadow-inner h-full">
      ...
      <Link to="/share" className={`flex items-center justify-center group ${location.pathname === '/share' ? 'text-violet-400' : 'text-zinc-300'}`}>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-share2-icon lucide-share-2">
