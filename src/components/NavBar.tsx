    ...
    <div className="flex col-span-2 items-center justify-between space-x-2  ">
      <div className="flex space-x-2 ">
        <button className="p-2 rounded text-neutral-400 hover:bg-gray-700">
          <svg viewBox="0 0 24 24" width="20" height="20"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4m4-5l5 5l5-5m-5 5V3"></path></svg>
        </button>
        <button className="p-2 rounded text-neutral-400 hover:bg-gray-700">
          <svg viewBox="0 0 24 24" width="20" height="20"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><path d="m4.93 4.93l4.24 4.24m5.66 0l4.24-4.24m-4.24 9.9l4.24 4.24m-9.9-4.24l-4.24 4.24"></path><circle cx="12" cy="12" r="4"></circle></g></svg>
        </button>
      </div>
      ...
      <div className="inline-flex items-center space-x-2">
        <button className="hidden md:flex items-center px-4 py-2 mb-2 border border-emerald-600/25 bg-emerald-500/10 text-emerald-500 text-sm hover:bg-emerald-600/20 hover:border-emerald-600/20 rounded">
          <svg viewBox="0 0 24 24" width="20" height="20" className="mr-2"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M12 13v8m-8-6.101A7 7 0 1 1 15.71 8h1.79a4.5 4.5 0 0 1 2.5 8.242"></path><path d="m8 17l4-4l4 4"></path></g></svg>
          Save My Workspace
        </button>
