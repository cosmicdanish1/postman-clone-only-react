        ...
        <div className="px-8 pb-4">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-4 mb-2">
            ...
            <div className="flex items-center gap-2 mb-2">
              ...
              <button className="ml-auto text-zinc-400 hover:text-white" title={t('help')}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg></button>
            </div>
            <div className="flex flex-col items-center justify-center py-8">
              ...
              <span className="text-zinc-400 text-sm mt-2">{t('environments_empty')}</span>
              <span className="text-zinc-500 text-xs mb-4">{t('import_or_create_collection')}</span>
