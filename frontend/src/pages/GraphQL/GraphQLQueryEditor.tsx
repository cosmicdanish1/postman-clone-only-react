      ...
      <div className="flex items-center justify-between px-4 pt-4 pb-2">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="text-gray-300 hover:text-white" title="Copy">
            <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v 1" /></svg>
          </button>
        </div>
      </div>
      {/* Monaco Editor for Query */}
      <div className="flex-1 flex min-h-0 px-4 bg-bg">
        <style>{`
